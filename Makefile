...
# Template: app
# Command: /usr/bin/qmake -o Makefile basic_graph.pro
#############################################################################
...
CFLAGS        = -fsanitize=address -g -pipe -O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -fno-plt -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -fsanitize=address -g -pipe -O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -fno-plt -std=gnu++1z -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
...
DISTDIR = /data/YandexDisk/Progs/graph-qt5/graph_qt5/.tmp/basic_graph1.0.0
LINK          = g++
LFLAGS        = -fsanitize=address -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now
...
Makefile: basic_graph.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -fno-plt -std=gnu++1z -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp
...
window.o: window.cpp /usr/include/qt/QtGui/QPainter \
		/usr/include/qt/QtGui/qpainter.h \
		/usr/include/qt/QtGui/qtguiglobal.h \
		/usr/include/qt/QtCore/qglobal.h \
		/usr/include/qt/QtCore/qconfig-bootstrapped.h \
